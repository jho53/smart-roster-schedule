...
class Nurse(Base):
    ...
    def __init__(self, id, first_name, last_name, clinical_area, bed_num):
    ...
    def _validate_positive_integer(input_value, int_value):
        ...
        if int_value is not isinstance(int_value, int):
